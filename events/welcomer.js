...
module.exports = class extends Event {
  ...
  run (member) {
    let embed = new Discord.MessageEmbed()
      ...
      .addField('Cracked Launchers', 'Impact client is only supported on [MultiMC](https://multimc.org/) and the official Minecraft launcher. That means it won\'t work if you are using a cracked launcher. [Just buy the game already.](https://www.minecraft.net/en-us/store/)')
