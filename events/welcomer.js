...
module.exports = class extends Event {
  ...
  run (member) {
    let embed = new Discord.MessageEmbed()
      ...
      .setDescription('In order to prevent spam and give you a chance to read the FAQs and rules, you will not be able to talk for ten minutes.\nIn the mean time, check the useful links below. Please do not DM a staff member while waiting. Try to resolve the problem using the FAQ, or the help channel when you can speak.')
